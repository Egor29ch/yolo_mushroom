...
while True:
    ...
    for i in range(len(detections)):
        ...
        if conf > 0.7:
            ...
            if object_count_Entoloma_Lividum >=2 and not stop_if_Entoloma_Lividum:
                root = tk.Tk()
...
При употреблении этот гриб раздражает слизистую оболочку желудочно-кишечного тракта, вызывая «резиноидный синдром» (боли в животе, рвота, жидкий стул)."""
            ...
            elif object_count_Amanita_Pantherina >=2 and not stop_if_Amanita_Pantherina:
                root = tk.Tk()
                root.title("Информационное сообщение")
...
При употреблении этот гриб раздражает слизистую оболочку желудочно-кишечного тракта, вызывая «резиноидный синдром» (боли в животе, рвота, жидкий стул)."""
            ...
            elif object_count_Hydnum_Rufescens >=2 and not stop_if_Hydnum_Rufescens:
                root = tk.Tk()
                root.title("Информационное сообщение")
